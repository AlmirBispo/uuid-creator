...
begin
    randomize;
t1:= random(65535);s1 := intparahex( t1,'0');
t2:= random(65535);s2 := intparahex( t2,'0');
t3:= random(65535);s3 := intparahex( t3,'0');
t4:= random(65535);s4 := intparahex( t4,'0');
t6:= random(65535);s6 := intparahex( t6,'0');
t7:= random(65535);s7 := intparahex( t7,'0');
t8:= random(65535);s8 := intparahex( t8,'0');
...
function GUIDMassiveCSV(GUIDCOUNT:integer ;  acase:string):string;
...
t3:= random(65535);s3 := intparahex( t3,'0');
t4:= random(65535);s4 := intparahex( t4,'0');
t5:= random(65535);s5 := intparahex( t5,'0');
t6:= random(65535);s6 := intparahex( t6,'0');
t7:= random(65535);s7 := intparahex( t7,'0');
t8:= random(65535);s8 := intparahex( t8,'0');
